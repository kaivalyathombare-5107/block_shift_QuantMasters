  ...
  return (
    <>
      ...
      <footer className="border-t border-border px-5 py-8 md:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 font-mono text-[10px] uppercase tracking-widest text-muted md:flex-row">
          <span>
            <span className="text-accent">[</span> YN <span className="text-accent">]</span> —
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Hidden point in footer redirecting to admin mode */}
            <Link
              href="/admin"
              ...
              title="Admin Portal"
              className="group relative inline-flex h-3 w-3 items-center justify-center rounded-full transition-all duration-300 focus:outline-none"
            >
              <span className="h-1.5 w-1.5 rounded-full bg-muted/40 transition-all duration-300 group-hover:h-2 group-hover:w-2 group-hover:bg-accent group-hover:shadow-[0_0_8px_#6ea8ff]" />
            </Link>
            <span>2026</span>
          </div>
        </div>
